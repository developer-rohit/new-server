...
client = MongoClient('mongodb://admin:admin@cluster0-shard-00-00-jd2q4.mongodb.net:27017,cluster0-shard-00-01-jd2q4.mongodb.net:27017,cluster0-shard-00-02-jd2q4.mongodb.net:27017/test?ssl=true&replicaSet=Cluster0-shard-0&authSource=admin&retryWrites=true&w=majority')
dbName = "ahb_database"
db = client[dbName]
...
def assignOneToEach(availableDoctors,availableReports,totalReports,doctorDetails,currtime):
	i=0
	j=0
...
# 
def assignAccordingToProbablity(availableDoctors,availableReports,totalReports,doctorDetails,ratio,currtime):
	i=0
	doctorCount = availableDoctors.count()
